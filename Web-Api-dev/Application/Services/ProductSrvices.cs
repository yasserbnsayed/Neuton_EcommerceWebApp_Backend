...
namespace Application.Services
{
    public class ProductSrvices : IProductServices
    {
        ...
        public async Task<List<ProductsWithCategoryNameDTO>> ProductsWithCategoryName()
        {
            var products = await _reposatory.GetAllAsync();
            var List = products.Include(x => x.Category);

            var ProductsList = _mapper.Map<List<ProductsWithCategoryNameDTO>>(List);
